...
public static int CNORMAL=2; // cnormal es l'index de creixement normal (sobre 100) = 4000;
...
// animal variables
public static int RACE1_MAX_AGE=1000;
public static int RACE2_MAX_AGE=1000;
// screen dimensions
